    ...
    <body class="<?php if (basename($_SERVER['PHP_SELF']) !== "index.php" && basename($_SERVER['PHP_SELF']) !== "" && basename($_SERVER['PHP_SELF']) !== "/") { ?> noIndexBody <?php } ?>">
        ...
        <header>
            <nav class="navbar navbar-expand-lg ">
                <div class="container">
                    <a class="navbar-brand" href="#"><img src="./assets/img/logo (1).webp" alt="" class="h-auto" width="190" height="49" aria-label="logo"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><a class="dropdown-item" href="./kookgroep-aansluiten.php">Krachtstroom aanleggen</a></li>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a class="dropdown-item" href="./groepenkast-laten-uitbreiden.php">Groepenkast uitbreiden</a></li>
                                                <li><a class="dropdown-item" href="./meterkast-vervangen.php">Meterkast vervangen</a></li>
                                                <li><a class="dropdown-item" href="./meterkast-verplaatsen.php">Meterkast verplaatsen</a></li>
                                                <li><a class="dropdown-item" href="./kookgroep-aansluiten.php">Kookgroep aansluiten</a></li>
                                                <li><a class="dropdown-item" href="./groepenkast-samenstellen.php">Groepenkast samenstellen</a></li>
                        ...
                        <form class="d-flex">
                            <a href="" class="theme-btn orange"><span><i class="fa-solid fa-phone"></i></span>
                                085-1107653</a>
                        </form>
                    </div>
                </div>
